...
一定要先申请，我是直接去创建application导致一开始没有上传网站数据
<!-- truncate -->

## 注册algolia

如果你有收到邀请邮件，algolia会给你的项目创建好一个application  
![图片](../static/img/2024-09-1312.33.05.png)  

在这里你可以获取Application ID、Search API Key 待会会用到    
